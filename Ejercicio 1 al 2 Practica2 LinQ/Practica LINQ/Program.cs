...
namespace Practica_LINQ
{
    internal class Program
    {
        static void Main(string[] args)
        {
            List<Persona> personas = new List<Persona>
         {
          ...
          new Persona {Nombre ="Maria" ,Edad =31 , Ciudad="Bogota"},
          ...
          new Persona {Nombre ="Jose" ,Edad =40 , Ciudad="Buenos Aires"}
            ...
            var Consulta1 = from p in personas
            ...
            {
                Console.WriteLine("Id Erroneo. Debe ingresar un numero Entero");
            }
        }
    }
    ...
    internal class Empleado
    {
        ...
        {
            Console.WriteLine("Empleado {0} con Id {1}, con Carga {3} y pertenece a " + "La Empresa{4}", Nombre, Id, Cargo, Salario, EmpresaId);
        }
    ...
    internal class ControlEmpresaEmpleados
    {
